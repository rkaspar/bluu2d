...
public class Hud implements Disposable {
	...
	public Hud(SpriteBatch sb) {
		...
		timeLabel = new Label("TIME", new Label.LabelStyle(new BitmapFont(),
				Color.WHITE));
		levelLabel = new Label("", new Label.LabelStyle(new BitmapFont(),
				Color.WHITE));
		worldLabel = new Label("", new Label.LabelStyle(new BitmapFont(),
				Color.WHITE));
		marioLabel = new Label("Score", new Label.LabelStyle(new BitmapFont(),
				Color.WHITE));
